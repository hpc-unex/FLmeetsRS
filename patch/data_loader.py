...
from .UCMERCED.data_loader import load_partition_data_ucmerced
from .RSICB256.data_loader import load_partition_data_RSICB256
...
def load_synthetic_data(args):
    ...
    if dataset_name == "mnist":
        ...
        (
            ...
            test_data_local_dict,
            class_num,
        ) = load_partition_data_ucmerced(
            args,
            args.batch_size,
            "/home/smoreno/fedml_data/data/UCMerced_LandUse/Images",
        )
        """
        For shallow NN or linear models, 
        we uniformly sample a fraction of clients each round (as the original FedAvg paper)
        ...
        if dataset_name == "cifar10":
            ...
            data_loader = load_partition_data_RSICB256
